    ...
    public partial class IGM_Junction
    {
        ...
        private class IGMData_CharacterInfo : IGMData.Base
        {
            ...
            protected override void Init()
            {
                ...
                ITEM[0, 5] = new IGMDataItem.Icon(Icons.ID.InParty, new Rectangle(X + 278, Y + 48, 0, 0), 6);
                ...
                ITEM[0, 13] = new IGMDataItem.Integer(0, new Rectangle(X + 192, Y + 231, 0, 0), 13, numtype: Icons.NumType.Num_8x8_2, padding: 1, spaces: 9);
                base.Init();
            }
