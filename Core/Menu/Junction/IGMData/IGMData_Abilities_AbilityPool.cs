...
namespace OpenVIII
{
    public partial class Junction
    {
        ...
        private class IGMData_Abilities_AbilityPool : IGMData.Pool.Base<IReadOnlyDictionary<Kernel.Abilities, Kernel.IEquippableAbility>, Kernel.Abilities>
        {
            ...
            {
                if (Junction != null && !Junction.GetMode().Equals(Mode.Abilities_Abilities))
                ...
                if (Contents[CURSOR_SELECT] != Kernel.Abilities.None && Junction.GetMode().Equals(Mode.Abilities_Abilities))
