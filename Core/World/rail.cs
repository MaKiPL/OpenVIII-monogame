...
namespace OpenVIII.World
{
    ...
    internal class rail
    {
        ...
        /// <summary>
        /// to reverse, but probably should be finally changed to vec4- it's normal vector, but
        /// relative to world coordinates of vanilla world map
        /// </summary>
