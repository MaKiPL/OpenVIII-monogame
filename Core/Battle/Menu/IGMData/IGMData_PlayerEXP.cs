...
namespace OpenVIII
{
    public partial class BattleMenus
    {
        public partial class VictoryMenu
        {
            ...
            {
                public IGMData_PlayerEXP(sbyte partypos) : base(1, 10, new IGMDataItem_Box(pos: new Rectangle(35, 78 + partypos * 150, 808, 150)), 1, 1, partypos: partypos) => Debug.Assert(partypos >= 0 && partypos <= 2);
