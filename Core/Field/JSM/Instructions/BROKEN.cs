...
namespace OpenVIII.Fields.Scripts.Instructions
{
    ...
    internal sealed class BROKEN : JsmInstruction
    {
        ...
        public BROKEN(Int32 parameter, IStack<IJsmExpression> stack)
            : this(
                arg7: stack.Pop(),
                arg6: stack.Pop(),
                arg5: stack.Pop(),
        ...
        {
            return $"{nameof(BROKEN)}({nameof(_arg0)}: {_arg0}, {nameof(_arg1)}: {_arg1}, {nameof(_arg2)}: {_arg2}, {nameof(_arg3)}: {_arg3}, {nameof(_arg4)}: {_arg4}, {nameof(_arg5)}: {_arg5}, {nameof(_arg6)}: {_arg6}, {nameof(_arg7)}: {_arg7})";
        }
    }
}