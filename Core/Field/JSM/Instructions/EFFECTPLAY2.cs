...
namespace OpenVIII.Fields.Scripts.Instructions
{
    ...
    /// <para>Note: It seems each area can have a maximum of 32 sounds predefined(meaning sound BattleID 31 is the highest you can play with this). You have to use EFFECTPLAY to use more than 32 sounds.</para>
    /// </summary>
