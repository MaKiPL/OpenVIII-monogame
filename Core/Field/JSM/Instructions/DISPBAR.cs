...
namespace FF8
{
    internal sealed class DISPBAR : JsmInstruction
    {
        ...
        public DISPBAR(Int32 parameter, IStack<IJsmExpression> stack)
            : this(
                arg6: stack.Pop(),
                arg5: stack.Pop(),
                arg4: stack.Pop(),
        ...
        {
            return $"{nameof(DISPBAR)}({nameof(_arg0)}: {_arg0}, {nameof(_arg1)}: {_arg1}, {nameof(_arg2)}: {_arg2}, {nameof(_arg3)}: {_arg3}, {nameof(_arg4)}: {_arg4}, {nameof(_arg5)}: {_arg5}, {nameof(_arg6)}: {_arg6})";
        }
    }
}