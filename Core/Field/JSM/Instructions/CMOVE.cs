...
namespace OpenVIII
{
    internal sealed class CMOVE : JsmInstruction
    {
        ...
        public CMOVE(Int32 parameter, IStack<IJsmExpression> stack)
            : this(
                arg3: stack.Pop(),
                arg2: stack.Pop(),
                arg1: stack.Pop(),
        ...
        {
            return $"{nameof(CMOVE)}({nameof(_arg0)}: {_arg0}, {nameof(_arg1)}: {_arg1}, {nameof(_arg2)}: {_arg2}, {nameof(_arg3)}: {_arg3})";
        }
    }
}