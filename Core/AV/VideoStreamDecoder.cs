...
{
    /// <summary>
    /// Helper Class for ffmpeg contains error handling.
    /// </summary>
    /// <see cref="https://github.com/Ruslan-B/FFmpeg.AutoGen/blob/master/FFmpeg.AutoGen.Example/FFmpegHelper.cs"/>
    ...
    /// <summary>
    /// Video Decorder with Hardware Accelleration.
    /// </summary>
    /// <see cref="https://github.com/Ruslan-B/FFmpeg.AutoGen/blob/master/FFmpeg.AutoGen.Example/VideoStreamDecoder.cs"/>
    public sealed unsafe class VideoStreamDecoder : IDisposable
    {
        ...
        public VideoStreamDecoder(string url, AVHWDeviceType HWDeviceType = AVHWDeviceType.AV_HWDEVICE_TYPE_NONE)
        {
            ...
            FrameSize = new Point(_pCodecContext->width, _pCodecContext->height);
