...
namespace FF8
{
    ...
    internal static class Ff8files
    {
        public class Data
        {
            ...
            public byte[] Items; //0x0B54 198 items (Item ID and Quantity)
            public uint Gametime; //0x0CE0
            ...
            public uint BattleTonberrySrkilled; //0x0CFC (yeah, this is a boolean)
            ...
            public byte[] CoordX; //0x0D56 signed  (party1, party2, party3)
            public byte[] CoordY; //0x0D5C signed  (party1, party2, party3)
            public byte[] Triangle_ID; //0x0D62  (party1, party2, party3)
