...
namespace FF8
{
    internal sealed class COFFSET : JsmInstruction
    {
        ...
        public COFFSET(Int32 parameter, IStack<IJsmExpression> stack)
            : this(
                arg3: stack.Pop(),
                arg2: stack.Pop(),
                arg1: stack.Pop(),
        ...
        {
            return $"{nameof(COFFSET)}({nameof(_arg0)}: {_arg0}, {nameof(_arg1)}: {_arg1}, {nameof(_arg2)}: {_arg2}, {nameof(_arg3)}: {_arg3})";
        }
    }
}