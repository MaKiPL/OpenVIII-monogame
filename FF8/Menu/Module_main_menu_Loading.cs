...
namespace FF8
{
    internal static partial class Module_main_menu_debug
    {
        ...
        private static void DrawLGChooseSlot()
        {
            ...
            dst = new Rectangle(
                (int)(vpWidth * 0.3703125f ), 
                (int)(vpHeight * 0.386111111f), 
                (int)(vpWidth * 0.259375f), 
                (int)(vpHeight* 0.141666667f));
        ...
        private static void DrawBox(byte[] buffer, Icons.ID? title, Rectangle dst, bool indent = true, bool bottom = false)
        {
            ...
            if (dst.Width> .5f * vpWidth)
                Memory.Icons.Draw(Icons.ID.Menu_BG_368, 0, dst, 2f, Fade);
            else
                Memory.Icons.Draw(Icons.ID.Menu_BG_256, 0, dst, 2f, Fade);
            ...
            if(indent)
                ...
                dst.Offset(0.01953125f * vpWidth * scale.X, dst.Height - 0.066666667f * vpHeight);
            else
