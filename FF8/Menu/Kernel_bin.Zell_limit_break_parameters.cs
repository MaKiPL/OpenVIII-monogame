...
namespace FF8
{
    internal partial class Kernel_bin
    {
        ...
        internal class Zell_limit_break_parameters
        {
            ...
            internal void Read(BinaryReader br, int i) => Moves = br.ReadBytes(4);//0x0000  1 byte[[StartMove 0//0x0001  1 byte  Next Sequence 0_1//0x0002  1 byte  Next Sequence 0_2//0x0003  1 byte  Next Sequence 0_3

            internal static Zell_limit_break_parameters[] Read(BinaryReader br)
            {
                var ret = new Zell_limit_break_parameters[count];
