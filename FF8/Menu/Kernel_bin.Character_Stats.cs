...
namespace FF8
{
    internal partial class Kernel_bin
    {
        ...
        internal struct Character_Stats
        {
            ...
            internal void Read(BinaryReader br, Saves.Characters char_id)
            {
            ...
            /// <returns></returns>
            internal int EXP(sbyte lvl) => ((lvl - 1) * (lvl - 1) * _EXP[1]) / 256 + (lvl - 1) * _EXP[0] * 10;
